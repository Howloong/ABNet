...
class UNet(nn.Module):
    ...
    def forward(self, inputs):
        # print('inputs:',inputs.shape) # [1, 3, 1024, 1024]
        h1 = self.firstconv(inputs)
        h1 = self.firstbn(h1)
        h1 = self.firstrelu(h1)
        # print('h1:',h1.shape) #[1, 64, 512, 512]
        h2 = self.firstmaxpool(h1)
        h2 = self.encoder1(h2)
        # print('h2:',h2.shape) #[1, 64, 256, 256]
        h3 = self.encoder2(h2)
        # print('h3:',h3.shape) # [1, 128, 128, 128]
        h4 = self.encoder3(h3)
        # print('h4:',h4.shape) # [1, 256, 64, 64]
        h5 = self.encoder4(h4)
        # print('h5:',h5.shape) # [1, 512, 32, 32]
        # hd5 = self.MSCE(h5)
        # print('hd5:',hd5.shape) # [1, 512, 32, 32]

        # DlinkNet34 Center
        h5 = self.dblock(h5)

        m2 = self.FSFF_2(h1, h2, h3, h4, h5)  # 320  256
        # print('m2:',m2.shape) # [1, 64, 256, 256]
        m3 = self.FSFF_3(h1, h2, h3, h4, h5)  # 320  128
        # print('m3:',m3.shape) # [1, 128, 128, 128]
        m4 = self.FSFF_4(h1, h2, h3, h4, h5)  # 320   64
        # print('m4:',m4.shape) # [1, 256, 64, 64]
